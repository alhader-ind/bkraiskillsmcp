...
8.2 Remote Skill Fetching

When a skill needs to be activated, fetch the full instructions from:

```
https://bkraiskillsmcp.pages.dev/skills/[skill-slug].md
```

For bulk loading, use the full knowledge base:

```
https://bkraiskillsmcp.pages.dev/llms-full.txt
```

8.3 Protocol Enforcement
